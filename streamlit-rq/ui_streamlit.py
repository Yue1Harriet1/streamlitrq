...
def layout_homepage_define_new_task(process_df, db_engine, user_defined_task:task.Task) -> None:
	"""
	...
	tasks_list = {t.name: t.func for t in user_defined_task.list_of_tasks}
