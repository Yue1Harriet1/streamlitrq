...
def start_scheduler_process(func, func_input, job_name:str):
...
def submit_task(func, func_input, job_name:str, task_name:str, start:datetime, interval_duration:timedelta, weekdays:Optional[List[str]], execution_type:str, task_id:int, db_engine:engine, worker_process, queue, queue_type:str="rq", execution_frequency:str="Once"):
	"""
	...
	process_df = create_process_info_dataframe(func, func_input, job_name, worker_process.pid, task_id)
